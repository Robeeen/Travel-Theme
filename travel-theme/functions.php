<?php
/**
 * travel-theme functions and definitions
 *
...
function travel_theme_setup() {
	/*
		...
		* If you're building a theme based on travel-theme, use a find and replace
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'travel_theme_custom_background_args',
			array(
...
function travel_theme_scripts() {
	wp_enqueue_style( 'travel-theme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'travel-theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'travel-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
